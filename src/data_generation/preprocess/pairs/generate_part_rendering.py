...
print('args.pair_id:' + args.pair_id)
print('args.azimuth:' + args.azimuth)
print('args.elevation:' + args.elevation)
...
output_node_seg.base_path = '/home/code/TMT/data/pairs/' + str(args.pair_id) + '/images/'
...
cam.location = spherical_to_cartesian(2, float(args.azimuth), float(args.elevation))
point_at(cam, (0., 0., 0.))
