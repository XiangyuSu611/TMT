...
def get_model(ref_dict, num_point, is_training, bn=False, bn_decay=None, img_size = (500,500), wd=1e-5, FLAGS=None):
...
def get_img_points(sample_pc, trans_mat_right, pred_xyshift, FLAGS):
    ...
    # maxtensor = tf.constant([499.0, 499.0], dtype=tf.float32)
