...
class RendNet3(nn.Module):
    ...
    def from_checkpoint(cls, checkpoint):
        ...
        num_classes = state_dict['fc_material.3.bias'].size(0)

        output_substance = 'fc_substance.3.weight' in state_dict
        num_substances = (state_dict['fc_substance.3.bias'].size(0)
    ...
    def __init__(self,
        ...
        self.fc_material = (
            nn.Sequential(
                nn.Linear(512 * resnet.BasicBlock.expansion, 512),
                nn.BatchNorm1d(512),
