...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--predictor_loss', action='store_true', help='if true, load predictor weight.')
        parser.add_argument('--substance_loss', action='store_true', help='if true, add substance loss')
        parser.add_argument('--material_loss', action='store_true', help='if true, add material loss')        
        parser.add_argument('--consistency_loss', action='store_true', help='if true, add consistency loss')        
        ...
        parser.add_argument('--weight_mask', type=float, default=20.0, help='weight of warped mask loss, used in direct/cycle')
        
        parser.add_argument('--weight_substanceCE', type=float, default=1.0, help='1')
        parser.add_argument('--weight_materialCE', type=float, default=1.0, help='1')
        parser.add_argument('--weight_materialDIS', type=float, default=1.0, help='1')
        parser.add_argument('--weight_mask_feat', type=float, default=10.0, help='1')
        parser.add_argument('--weight_imgPrec', type=float, default=1.0, help='1')
