...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--mat_dis_path', type=str, default='./pho_predictor/mat_dis/total_similarity_matrix_sqrt_600.csv')
        ...
        parser.add_argument('--label_nc', type=int, default=57, help='# of input label classes without unknown class. If you have unknown class as class label, specify --contain_dopntcare_label.')
        parser.add_argument('--mat_num', type=int, default=600, help='# number of materials.')
        parser.add_argument('--contain_dontcare_label', action='store_true', help='if the label map contains dontcare label (dontcare=255)')
        parser.add_argument('--output_nc', type=int, default=3, help='# of output image channels')

        # for setting inputs
        parser.add_argument('--dataroot', type=str, default='/home/code/TMT/data/image_translation')
        # parser.add_argument('--dataset_mode', type=str, default='rendered')
